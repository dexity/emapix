...
public class ActionBubble extends MainView 
{
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout bubble	= bubbleFactory(R.layout.test_action_bubble, point);
        // Set text
    	TextView tvd = (TextView)bubble.findViewById(R.id.description);
    	tvd.setText("Planning to hike in this place ...");
        // Set text
